...
<div class="pageTable">
    <form method="post" action="my_profile.php">
		<table width="100%" cellpadding="5" cellspacing="0" border="0">
               <tr valign="top">
					<td colspan="2"><div class="formTitle">Account Information</div><div class="tableSubTitleInfo">* Indicates required field.</div></td>
				</tr>
                <tr valign="top">
				...
				<tr valign="top">
					<td colspan="2"><div class="formTitle">Personal Information</div></td>
				</tr>
				<tr valign="top">
...
<select name="birthday_yr">
    ...
    ?>
				...
				<tr valign="top">
					<td colspan="2"><br><div class="formTitle">Location Information</div></td>
				</tr>
				<tr valign="top">
...
echo '</select>';?></td>
				...
				<tr valign="top">
					<td colspan="2"><br><div class="formTitle">Random Information</div><div class="tableSubTitleInfo">Separate items with commas.</div></td>
