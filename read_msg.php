...
<table width="100%" align="center" cellpadding="1" cellspacing="1" border="0" bgcolor="#EEEEEE">
	...
	<table width="75%" cellpadding="4" cellspacing="9" table="table" align="center">
                <tbody><tr><td colspan="1" height="10" width="35" align="right"></td></tr>
					...
					<td><a href="profile.php?user=<?php echo htmlspecialchars($msg['username']);?>"><?php echo htmlspecialchars($msg['username']);?></a></tr>
                    
                <tr>
					<td align="right">&nbsp;</td>
					<td><a href="profile_videos.php?user=<?php echo htmlspecialchars($msg['username']);?>">Videos</a> (<?php echo $profile['videos']; ?>) | <a href="profile_favorites.php?user=<?php echo htmlspecialchars($msg['username']);?>">Favorites</a> (<?php echo $profile['favorites']; ?>)</td>
				</tr>
                <tr valign="top">
