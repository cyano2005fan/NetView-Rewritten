...
try {
    ...
    //Recipients
    $mail->setFrom($config["email"], 'YuoToob Support');
...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	<tbody>
		<tr>
			<td height="177" align="right" width="62" bgcolor="#ff3333" style="vertical-align: top;">Solution:</td>
			<td style="vertical-align: top;">'. $_POST['solution'].'
        <p>Thanks you for using YuoToob,<br>The YuoToob Team</td>
		</tr>
	</tbody>
</table>';
                 ...
                 <div class="moduleEntry">
					<table width="565" cellpadding="0" cellspacing="0" border="0">
						<tbody><tr valign="top">
							...
							<p><strong>Email Match</strong>: <a href="../profile.php?user=<?php echo htmlspecialchars($msg['username']); ?>"><?php echo htmlspecialchars($msg['username']); ?></a><? } ?>
