		...
		<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
			...
			<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tbody><tr valign="top">
						<td><div class="moduleTitle"><?php echo htmlspecialchars(trim($res_title)); ?> // <?php echo $real_search; ?> (<?php if($vidocount != 0) { echo $vidocount; } else { echo "0"; } ?> result<?php if($vidocount != 1) { ?>s<? } ?>)</div></td>
						<td align="right"><a href="rss/tag/<?php echo $real_search; ?>.rss"><img src="img/rss.gif" width="36" height="14" border="0" style="vertical-align: text-top;"></a> 
						<span style="font-size: 11px; margin-right: 3px;"><a href="rss/tag/<?php echo $real_search; ?>.rss">Feed For Tag // <?php echo $real_search; ?></a></span></td>
					</tr>
				</tbody></table>
				</div>
...
<?php if(empty($videos) || $vidocount == 0) { ?>
<br>
