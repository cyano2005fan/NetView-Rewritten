...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr valign="top">
		...
		<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
			...
			$profile['favorites'] = $conn->prepare("SELECT fid FROM favorites WHERE vid = ?");
			$profile['favorites']->execute([$video["vid"]]);
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tr valign="top">
						...
						<td width="100%"><div class="moduleEntryTitle"><a href="index.php?v=<?php echo htmlspecialchars($video['vid']); ?>"><?php echo htmlspecialchars($video['title']); ?></a></div>
							...
							<div class="moduleEntryDetails">Runtime: <?php echo gmdate("i:s", $video['time']); ?> | Views: <?php echo $video['views']; ?> | Comments: <?php echo $video['comm_count']; ?> | Fans: <?php echo $favorites; ?></div>
							...
							<div class="moduleEntryDetails">Status: <?php echo ($video['converted'] == 1) ? "Live!" : "Processing..."; ?></div>
								<form name="linkForm_<?php echo htmlspecialchars($video['vid']); ?>" id="linkForm_<?php echo htmlspecialchars($video['vid']); ?>">
									<input name="video_link" type="text" onClick="document.linkForm_<?php echo htmlspecialchars($video['vid']); ?>.video_link.focus();document.linkForm_<?php echo htmlspecialchars($video['vid']); ?>.video_link.select();" value="http://www.<? echo $sitedomain; ?>/?v=<?php echo htmlspecialchars($video['vid']); ?>" size="50" readonly="true" style="font-size: 10px; text-align: center;">
